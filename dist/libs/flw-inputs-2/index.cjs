(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.FlwInputs2 = factory(global.jsxRuntime, global.React));
	...
	const ClickCounter = ({
	  ...
	  return jsxRuntime.jsxs(jsxRuntime.Fragment, {
	    children: [jsxRuntime.jsxs("div", Object.assign({
	      className: "flo-clickCounter",
	      onClick: onClick
	    }, {
	      children: [config.label || 'Count:', " ", jsxRuntime.jsx("br", {})]
	    })), jsxRuntime.jsxs("div", Object.assign({
	      className: "flo-clickCounterDebug"
	    }, {
	      children: ["Component State: ", count, " ", jsxRuntime.jsx("br", {}), "config.value: ", config.value, " ", jsxRuntime.jsx("br", {}), "Payload: ", JSON.stringify(payload)]
	    }))]
	  });
	};
